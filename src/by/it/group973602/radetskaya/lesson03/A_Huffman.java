package by.it.group973602.radetskaya.lesson03;
...
public class A_Huffman {
    ...
    abstract class Node implements Comparable<by.it.group973602.radetskaya.lesson03.A_Huffman.Node> {
        ...
        //или для сортировок
        @Override
        public int compareTo(by.it.group973602.radetskaya.lesson03.A_Huffman.Node o) {
    ...
    private class InternalNode extends by.it.group973602.radetskaya.lesson03.A_Huffman.Node {
        //внутренный узел дерева
        by.it.group973602.radetskaya.lesson03.A_Huffman.Node left;  //левый ребенок бинарного дерева
        by.it.group973602.radetskaya.lesson03.A_Huffman.Node right; //правый ребенок бинарного дерева

        //для этого дерева не существует внутренних узлов без обоих детей
        //поэтому вот такого конструктора будет достаточно
        InternalNode(by.it.group973602.radetskaya.lesson03.A_Huffman.Node left, by.it.group973602.radetskaya.lesson03.A_Huffman.Node right) {
    ...
    private class LeafNode extends by.it.group973602.radetskaya.lesson03.A_Huffman.Node {
        //лист
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        PriorityQueue<by.it.group973602.radetskaya.lesson03.A_Huffman.Node> priorityQueue = new PriorityQueue<>();

        count.forEach((key, value) -> priorityQueue.add(new by.it.group973602.radetskaya.lesson03.A_Huffman.LeafNode(value, key)));
        //3. вынимая по два узла из очереди (для сборки родителя)
        //и возвращая этого родителя обратно в очередь
        //построим дерево кодирования Хаффмана.
        //У родителя частоты детей складываются.
        while (priorityQueue.size() > 1) {
            priorityQueue.add(new by.it.group973602.radetskaya.lesson03.A_Huffman.InternalNode(priorityQueue.remove(),priorityQueue.remove()));
        }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        by.it.group973602.radetskaya.lesson03.A_Huffman instance = new by.it.group973602.radetskaya.lesson03.A_Huffman();
