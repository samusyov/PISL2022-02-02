package by.it.group973601.kozyarskaya.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (Map.Entry<Character, Integer> entry : count.entrySet()) priorityQueue.add(new by.it.group973601.kozyarskaya.lesson03.A_Huffman.LeafNode(entry.getValue(), entry.getKey()));
        ...
        while (priorityQueue.size() > 1) {
            by.it.group973601.kozyarskaya.lesson03.A_Huffman.Node n1 = priorityQueue.poll();
            by.it.group973601.kozyarskaya.lesson03.A_Huffman.Node n2 = priorityQueue.poll();
            priorityQueue.add(new by.it.group973601.kozyarskaya.lesson03.A_Huffman.InternalNode(n1, n2));
        }
