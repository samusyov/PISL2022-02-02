package by.it.group973601.shpak.lesson03;
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for(Character character : s.toCharArray()) {
            if(!count.containsKey(character)) {
                ...
                count.replace(character,count.get(character),count.get(character)+1);
            }
        }
        ...
        PriorityQueue<Node> priorityTempQueue = new PriorityQueue<>();
...
//            Node rightNode;
//            Node extraNode;
//            priorityTempQueue = new PriorityQueue<>();
//            while (priorityQueue.size() > 0){
//                if(priorityQueue.size() >= 2) {
//                    leftNode = priorityQueue.poll();
//                    rightNode = priorityQueue.poll();
//                    priorityTempQueue.add(new InternalNode(leftNode,rightNode));
//                } else {
//                    extraNode = priorityQueue.poll();
//                    priorityTempQueue.add(extraNode);
//                }
//            }
//            priorityQueue = priorityTempQueue;
//        }
        while (priorityQueue.size() > 1) {
            Node leftNode;
            Node rightNode;
        ...
        //.....
        priorityQueue.peek().fillCodes(String.valueOf(sb));
        for (Character character :s.toCharArray()) {
