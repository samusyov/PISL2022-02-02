...
public class C_GetInversions {
    private static int inversionsAmount = 0;
    ...
    int[] merge(int[] ar_1, int[] ar_2){
        ...
        for (int i = 0; i < max; i++){
            if (m >= ar_1.length & n < ar_2.length){
                ...
                inversionsAmount += ar_1.length - m;
                result[i] = ar_2[n];
                n++;
            }
        }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group973601/shpak/lesson04/dataC.txt");
