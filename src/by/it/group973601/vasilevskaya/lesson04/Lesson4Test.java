package by.it.group973601.vasilevskaya.lesson04;
...
public class Lesson4Test {
    ...
    public void A() throws Exception {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group973601/vasilevskaya/lesson04/dataA.txt");
    ...
    public void B() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream stream = new FileInputStream(root + "by/it/group973601/vasilevskaya/lesson04/dataB.txt");
