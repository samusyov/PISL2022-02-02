package by.it.group973603.rusetskii.lesson01.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        while (priorityQueue.size()>1){
            InternalNode intNode = new InternalNode(priorityQueue.remove(), priorityQueue.remove());
            priorityQueue.add(intNode);
        }
